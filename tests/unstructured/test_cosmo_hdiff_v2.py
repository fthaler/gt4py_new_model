...
# @stencil
# def hdiff_flux_x(inp, fpconn):
#     lap = lift(laplacian, fpconn)(inp)
#     flux = lap[bottomrightn.center] - lap[bottomrightn.right]

#     return (
#         0 if flux * (inp[bottomrightn.right] - inp[bottomrightn.center]) > 0 else flux
#     )


# @stencil
# def hdiff_flux_y(inp, fpconn):
#     lap = lift(laplacian, fpconn)(inp)
#     flux = lap[bottomrightn.center] - lap[bottomrightn.bottom]

#     return (
#         0 if flux * (inp[bottomrightn.bottom] - inp[bottomrightn.center]) > 0 else flux
#     )
